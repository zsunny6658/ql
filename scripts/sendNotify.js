...
const push_config = {
  ...
  */
  ...
  SMTP_SERVICE: 'QQ', // 邮箱服务名称，比如 126、163、Gmail、QQ 等，支持列表 https://github.com/nodemailer/nodemailer/blob/master/lib/well-known/services.json
  SMTP_EMAIL: '498364417@qq.com', // SMTP 收发件邮箱，通知将会由自己发给自己
  SMTP_PASSWORD: 'uldzyylytwuqbihf', // SMTP 登录密码，也可能为特殊口令，视具体邮件服务商说明而定
  SMTP_NAME: '青龙通知', // SMTP 收发件人姓名，可随意填写
